...
class swinfusion_decoder(nn.Module):
    r""" SwinIR
    ...
    def __init__(self, img_size=64, patch_size=1, in_chans=1,
                 ...
                 **kwargs):
        super(swinfusion_decoder, self).__init__()
        num_out_ch = in_chans
        num_feat = 64
        ...
        # self.conv_first1_B = nn.Conv2d(1, embed_dim_temp, 3, 1, 1)
...
if __name__ == '__main__':
    ...
    height = 128
    width = 128
    model = swinfusion_decoder(upscale=2, img_size=(height, width),
