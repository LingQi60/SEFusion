...
class ModelPlain(ModelBase):
    ...
    def optimize_parameters(self, current_step):
        ...
        if G_lossfn_type in ['loe', 'gt']:
            ...
            total_loss, gradient_loss, contrast_loss, color_angle_loss, l1_loss, exp_loss = self.G_lossfn(self.img_vi_Y, self.img_ir, self.Y_E, self.E, self.A)
        ...
        if G_lossfn_type in ['loe', 'mef', 'vif', 'mff', 'gt', 'nir', 'med']:
            ...
            self.log_dict['Exp_loss'] = exp_loss.item()
