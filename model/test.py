...
import time
import sys
from models.model import SEFusion as net
...
def main():
    ...
    parser.add_argument('--iter_number', type=str,
                        default='1000')
    parser.add_argument('--root_path', type=str, default='./data/MSRS-main',
...
def setup(args):   
    save_dir = f'results/fusion_{args.dataset}'
...
def test(img_a, img_b, model, args, window_size):
    if args.tile is None:
        ...
        input_vis_img_y, infrared_img_1, fusion_img_Y, output_img = model(img_a, img_b)
    else:
